        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <!-- form start -->
                    <form action="{{route('admin.update.testimonials',$testimonials->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="name"
                                        ...
                                        placeholder="Enter Testimonial name" autocomplete="off" value="{{$testimonials->name}}">
                                    @error('name')
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="role"
                                        ...
                                        placeholder="Enter Testimonial role" autocomplete="off" value="{{$testimonials->role}}">
                                    @error('role')
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="4" cols="50">{{$testimonials->description}}</textarea>
                                @error('description')
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <img src="{{URL::asset('images/testimonial_images').'/'.$testimonials->images}}" alt="" width="30%" height="50%">
