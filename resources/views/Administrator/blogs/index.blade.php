      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <a href="{{route('admin.add.blogs')}}" class=" btn btn-info">+ Create Blog</a>
          ...
          <div class="card-body">
            <table id="example1" class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td>{{$i++}}</td>
                  <td><img src="{{URL::asset('images/blog_images').'/'.$blog->images}}" alt="" width="60px"
                      height="60px"></td>
                  <td>{{$blog->title}}</td>
                  ...
                  <td>
                    {{-- <div class="card-body switch"> --}}
                      <div class="switch">
                        <input type="checkbox" name="toogle" value="{{$blog->id}}" {{$blog->status=='Active' ?
                  ...
                  <td>
                    <a href="{{route('admin.edit.blogs',$blog->id)}}"><i class="fa fa-edit"></i></a>

                    <form style="margin-left: 36px; margin-top: -24px;" action="{{route('admin.delete.blogs',$blog->id)}}" method="POST">

                      @csrf

                      <a href="" data-toggle="tooltip" title="delete" data-id="{{$blog->id}}" style="color: red" data-placement="botton"><i class="far fa-trash-alt dltBtn"></i></a>
...
<script>
  $('input[name=toogle]').change(function(){
      ...
      console.log(id);
      $.ajax({
        url:"{{route('admin.blogs.status_change')}}",
        type:"POST",
        data:{
          _token:'{{csrf_token()}}',
          mode:mode,
