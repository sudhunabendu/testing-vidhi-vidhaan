          ...
          <div class="card-body">
            <table id="example2" class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td>{{$i++}}</td>
                  <td><img src="{{URL::asset('images/category_images').'/'.$category->images}}" alt="" width="60px"
                      height="60px"></td>
                  <td>{{$category->name}}</td>
                  ...
                  <td>
                    {{-- <div class="card-body switch"> --}}
                      ...
                      @else
                      <div class="switch">
                        <input type="checkbox" name="toogle" value="{{$category->id}}" {{$category->status=='Active' ?
                  ...
                  <td>
                    ...
                    @else
                      <a href="{{route('admin.edit.categories',$category->id)}}"><i class="fa fa-edit"></i></a>
                      <form style="margin-left: 36px; margin-top: -24px;" action="{{route('admin.delete.categories',$category->id)}}" method="POST">
                        @csrf
                        <a href="" data-toggle="tooltip" title="delete" data-id="{{$category->id}}" style="color: red" data-placement="botton"><i class="far fa-trash-alt dltBtn"></i></a>
