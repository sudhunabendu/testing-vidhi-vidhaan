        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <a href="{{route('admin.create.gemstones')}}" class=" btn btn-info">+ Create Gemstone</a>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>{{$i++}}</td>
                    <td>{{\App\Models\Category::where('id',$category->category_id)->value('name')}}</td>
                    <td><img src="{{URL::asset('images/product_images').'/'.$category->images}}" alt="" width="60px"
                        height="60px"></td>
                    <td>{{$category->name}}</td>
