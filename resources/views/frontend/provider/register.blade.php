                ...
                <div class="col-lg-6">
                    <div class="inner-main-login-form-box">
                        ...
                        <div class="login-form-box">
                            <form action="{{route('provider.post.registration')}}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-6">
                                ...
                                <p class="sign-up-txt">Already have an account?<a href="{{route('provider.login')}}"> Log In</a>
                                </p>
                            </form>
                        </div>
                    </div>
