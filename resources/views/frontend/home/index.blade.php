                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4">
                        <div class="banner-img-box">
                            <img src="{{ URL::asset('/frontend/assets/images/Only-ICon.gif') }}" class="banner-img"
                                alt="">
                        </div>
                    </div>
                </div>
            ...
            <div class="row home_about_us_inr_spcr">
                <div class="col-md-5 col-12">
                    <div class="home_about_leftimgwrap">
                        ...
                        <img class="home_about_leftimg"
                            src="{{ URL::asset('/frontend/assets/images/aboutleftimage.png') }}">
                    </div>
                </div>
                                ...
                                <a href="{{ route('astrologer.details', $provider->first_name) }}">
                                    <div class="item">
                                        <div class="book_astrologer_carowsal_innr">
                                            ...
                                            <div class="service_carowsal_text">
                                                <h2>{{ ucfirst($provider->first_name) . ' ' . ucfirst($provider->last_name) }}
                                                </h2>
                ...
                @foreach ($blogs as $item)
                    <div class="col-md-4 col-12">
                        <div class="blog_box_wrap">
                            <img src="{{ URL::asset('images/blog_images') . '/' . $item->images }}">
                        ...
                        <div class="testimonial-main-box">
                            ...
                            <div class="testimonial-maincontent-box">
                                <div class="testimonial-maincontent">
                                    <img src="{{ URL::asset('/frontend/assets/images/quote.png') }}" class="quote-icon"
                                        alt="">
                    ...
                    <div class="testimonial-main-box">
                        ...
                        <div class="testimonial-maincontent-box">
                            <div class="testimonial-maincontent">
                                ...
                                <div class="testimonial_new_bx">
                                    <div class="testimonial_flexbox">
                                        <img src="{{ URL::asset('/frontend/assets/images/testimonial-img2.png') }}"
                                            alt="">
                                        <div>
                                            <h3>Mitchel Jones</h3>
                                            <p>Founder & CEO</p>
                    ...
                    <div class="testimonial-main-box">
                        ...
                        <div class="testimonial-maincontent-box">
                            <div class="testimonial-maincontent">
                                ...
                                <div class="testimonial_new_bx">
                                    <div class="testimonial_flexbox">
                                        <img src="{{ URL::asset('/frontend/assets/images/testimonial-img3.png') }}"
                                            alt="">
                                        <div>
                                            <h3>Mitchel Jones</h3>
                                            <p>Founder & CEO</p>
                    ...
                    <div class="testimonial-main-box">
                        ...
                        <div class="testimonial-maincontent-box">
                            <div class="testimonial-maincontent">
                                ...
                                <div class="testimonial_new_bx">
                                    <div class="testimonial_flexbox">
                                        <img src="{{ URL::asset('/frontend/assets/images/testimonial-img1.png') }}"
                                            alt="">
                                        <div>
                                            <h3>Mitchel Jones</h3>
                                            <p>Founder & CEO</p>
