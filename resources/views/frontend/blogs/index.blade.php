            ...
            <div class="col-lg-8">
                <div class="inner-main-blog-box">
                    <div class="inner-blog-heading-hd">
                      <a href="blog-details.html"><h3 class="info_about_title">Blog <span>Heading 1</span></h3> </a>
              
                    </div>
                    <div class="inner-blog-img-box">
                        <img src="{{URL::asset('frontend/assets/images/homeblog1.png')}}" alt="">
                    </div>
                    <p> Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod
                        tempor invidunt ut labore et dolore There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form,
                    </p>
                    <p>by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure.</p>
                    <div class="blg-like-view-date">
                        <ul class="list-inline">
                            <li><img src="{{URL::asset('frontend/assets/images/like.svg')}}" alt=""> <a href="#">2.5k likes</a></li>
                            <li><img src="{{URL::asset('frontend/assets/images/view.svg')}}" alt=""> <a href="#">5k views</a></li>
                        </ul>
                        <p>17th July, 2021</p>
                    </div>
                </div>
                <div class="inner-main-blog-box">
                  <div class="inner-blog-heading-hd">
                    <a href="blog-details.html"><h3 class="info_about_title">Blog <span>Heading 2</span></h3> </a>
              ...
              <div class="inner-main-blog-box">
                <div class="inner-blog-heading-hd">
                  <a href="blog-details.html"><h3 class="info_about_title">Blog <span>Heading 3</span></h3> </a>
