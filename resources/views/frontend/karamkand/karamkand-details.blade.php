             ...
             <div class="col-md-7 col-12">
                ...
                <div class="karamkand_dtl_info_wrap">
                   ...
                   <ul class="list-inline karamkand_dtl_ul mb-0">
                      ...
                      {{-- <li><h6>Qualification : <span>{{ucfirst($karmkand->userDetails->education)}}</span></h6></li> --}}
                   ...
                   <div class="choose_your_slot">
                      ...
                      <div class="page_about_btnerp pt-2">
                         ...
                         <button type="button" class="btn page_btn_dark" data-toggle="modal" data-target="#karmkandModal">Book Online</button>
                      </div>
                   </div>
